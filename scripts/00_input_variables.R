...
variables <- list("chlpoly4"=list(name_dropdown="POLY4 chl-a (regional, band ratio)",
                  ...
                  "chleof"=list(name_dropdown="EOF chl-a (regional, empirical)",
                                ...
                                log=TRUE,
                                cell_model_option=TRUE),
                  "chlocxspmcor"=list(name_dropdown="OCxSPMcor chl-a (regional, band ratio)",
                                      name_plottitle="Chlorophyll-a",
                                      abbrev="Chl-a",
                                      map_legend_title="<center>Chl-a</br>[ mg/m<sup>3</sup> ]</center>",
                                      timeseries_ytitle=bquote("Chl-a [" * mg/m^3 * "]"),
...
startup_popup <- paste0("This app can be used to display satellite data such as chlorophyll-a and Sea Surface Temperature (SST), and model phytoplankton blooms. Use the controls in the left panel to visualize statistics for regions of interest or draw your own, and export data and graphs.<br><br>",
                      ...
                      "<b>How to cite:</b><br>",
                      "Raw satellite data is provided by <a href=\"https://oceancolor.gsfc.nasa.gov/\">NASA's Ocean Biology Processing Group (OBPG)</a>, and the multisensor OC-CCI product is generated by the <a href=\"https://www.oceancolour.org/\">Plymouth Marine Laboratory (PML)</a> as part of the European Space Agency (ESA) climate change initiative. The <a href=\"https://bio-rsg.github.io/\">Satellite Ocean colour and Phytoplankton Ecology group (SOPhyE)</a> from the Bedford Institute of Oceanography in Dartmouth, NS, uses the reflectances to generate regionally-optimized chlorophyll-a products (POLY4, GSM_GS).<br>",
                      "In publications, please include acknowledgments to NASA OBPG for the satellite data or PML for the OC-CCI product, as well as an acknowledgement to SOPhyE for the application and regionally optimized products. In the bibliography, please include the citation for PhytoFit:<br>",
                      "<i>Stephanie Clay, Chantelle Layton, & Emmanuel Devred. (2021). BIO-RSG/PhytoFit: First release (v1.0.0). Zenodo. https://doi.org/10.5281/zenodo.4770754</i><br>",
                      "and if applicable, the citations listed <a href=\"https://climate.esa.int/en/projects/ocean-colour/data/#citing-ocean-colour-cci-information-and-data-products\">here</a> for the OC-CCI products (note that PhytoFit contains OC-CCI version 6.0).<br><br>",
                      "<b>Contact:</b><br>",
