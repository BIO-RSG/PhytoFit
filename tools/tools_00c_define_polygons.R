...
poly$atlantic = list(
  "AZMP"=list("AC"=list(name = "Avalon Channel (AC)",
              ...
              "HL2"=list(name="Halifax Line 2 (HL2)",
                         label="HL2",
              ...
              "S27"=list(name="Station 27 (S27)",
                         label="S27",
                         lat=c(47.585, 47.52, 47.52, 47.585, 47.585),
                         lon=c(-52.59, -52.59, -52.5, -52.5, -52.59)),
...
region <- "tanzania"
poly[[region]] = list(
  "CoastalPolygons"=list("TC"=list(name = "Tanga Coast (TC)", # this appears in the polygon dropdown menu
                                   label = "TC", # this is the label that appears over the polygon on the map
                                   lat = c(-6,-5.66,-5.42,-5.26,-5.14,-4.99,-4.76,-4.76,-5.36,-5.67,-5.71,-5.85,-6,-6),
                                   lon = c(38.88,38.99,39.1,39.18,39.23,39.25,39.32,39.59,39.47,39.27,39.19,39.15,39.13,38.88))))
